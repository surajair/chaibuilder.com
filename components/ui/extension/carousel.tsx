...
const CarouselMainContainer = forwardRef<
  HTMLDivElement,
  { mainContainerOuterClasses?: string } & React.HTMLAttributes<HTMLDivElement>
>(({ className, dir, children, mainContainerOuterClasses, ...props }, ref) => {
  ...
  return (
    <div
      {...props}
      ref={mainRef}
      className={twMerge('overflow-hidden', mainContainerOuterClasses)}
      dir={direction}
    >
      <div
        ref={ref}
